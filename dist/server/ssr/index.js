...
var client_references_default = {
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-DTXsQSuZ.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-B2TiF9fh.js");
		return {
			get "ErrorBoundary"() {
	...
	"6efdf509a785": async () => {
		const m = await import("./assets/page-Drlgp9fz.js");
		return { get "default"() {
			return m["default"];
		} };
	},
